...
This project demonstrates the pulse counting functionality of the lpTMR.

- Short PTE11 to PTD14 to perform self-test
- PTD14 automatically toggles to generate pulses for lpTMR counting
