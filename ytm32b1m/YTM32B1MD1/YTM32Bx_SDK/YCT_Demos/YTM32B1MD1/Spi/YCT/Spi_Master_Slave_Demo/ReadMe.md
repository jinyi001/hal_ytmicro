# Spi_Master_Slave_Demo

---

## Function Description

This example demonstrates data transmission and reception between an SPI Master and an SPI Slave using interrupt mode, along with a self-test procedure:
