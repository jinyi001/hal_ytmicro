# Linflexd_Uart_DMA_Demo

---

## Function Description

This project is used to demonstrate the UART transmission of the Linflexd module using the DMA mode:

- Short PTC2 to PTC3 to test the routine
- The UART transmits and receives data (by connecting the TX and RX lines)
