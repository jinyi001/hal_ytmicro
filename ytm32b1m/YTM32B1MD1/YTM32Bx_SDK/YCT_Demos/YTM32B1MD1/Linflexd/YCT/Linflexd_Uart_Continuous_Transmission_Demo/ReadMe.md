# Linflexd_Uart_Continuous_Transmission_Demo

---

## Function Description

This project demonstrates the UART continuous transmission functionality.

- Short PTC2 to PTC3 to test the routine
- The UART transmits data using a frame-by-frame continuous transmission method
- The receiver will process each frame sequentially
