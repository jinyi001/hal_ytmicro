# Adc_All_Channel_Demo

---

## Function Description

This example demonstrates converting the voltage of all ADC channels and printing the results.
...
3. Print the voltages of all channels, including internal channels, along with the temperature sensor results.
