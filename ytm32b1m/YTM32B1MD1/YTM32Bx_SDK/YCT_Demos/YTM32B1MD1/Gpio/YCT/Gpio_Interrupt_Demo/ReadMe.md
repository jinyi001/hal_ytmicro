...
This example demonstrates the GPIO interrupt functionality along with a self-test procedure:

- Short PTC13 to PTB2 to perform self-test
- PTC13 automatically toggles its output, each toggle triggering a GPIO interrupt on PTB2
