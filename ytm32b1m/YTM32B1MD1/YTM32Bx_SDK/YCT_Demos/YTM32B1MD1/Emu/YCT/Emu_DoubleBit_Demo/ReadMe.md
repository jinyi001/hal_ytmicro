...
This example demonstrates the double-bit ECC error injection and detection functionality of the EMU module:

- Inject a double-bit error into a specific SRAM address
- Access the erroneous address
- Trigger a HardFault
- Execute a software reset within the HardFault interrupt handler
- Verify whether the error address matches the injection address after reset
