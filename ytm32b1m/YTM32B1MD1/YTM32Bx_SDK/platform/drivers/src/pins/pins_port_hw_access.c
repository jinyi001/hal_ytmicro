 ...
 * @version 1.4.1
 *
 * @brief PINS PORT Hardware Access Layer — non-inline PCTRL helpers.
 *
 * This file contains the PCTRL access routines that are implemented in source
 * form rather than as header inlines.
 */
