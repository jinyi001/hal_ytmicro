...
#elif defined (FEATURE_EFM_DATA_ARRAY0_START_ADDRESS) && defined (FEATURE_EFM_DATA_ARRAY1_START_ADDRESS)
    /* There is two dflash can be used */
    #define FLS_ADDRESS_VALID_D0_FLASH(addr)    ( ((addr) >= (FEATURE_EFM_DATA_ARRAY0_START_ADDRESS)) && ((addr) <= (FEATURE_EFM_DATA_ARRAY0_END_ADDRESS)) )
    #define FLS_ADDRESS_VALID_D1_FLASH(addr)    ( ((addr) >= (FEATURE_EFM_DATA_ARRAY1_START_ADDRESS)) && ((addr) <= (FEATURE_EFM_DATA_ARRAY1_END_ADDRESS)) )

    /* @brief Valid D_FLASH address */
    #define FLS_ADDRESS_VALID_D_FLASH(addr)     ( FLS_ADDRESS_VALID_D0_FLASH(addr) || FLS_ADDRESS_VALID_D1_FLASH(addr) )
#endif
