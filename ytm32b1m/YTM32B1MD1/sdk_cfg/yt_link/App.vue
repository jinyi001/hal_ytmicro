...
import YTM32B1ME15Mcal from "./me15_mcal.json";
...
const defaultLinkMap: Record<string, LinkItem[]> = {
  ...
  YTM32Z1LS16_SDK: YTM32B1LE15Def as LinkItem[],
  YTM32Z1LS15_SDK: YTM32B1LE14Def as LinkItem[],
  ...
  YTM32B1ME15_MCAL: YTM32B1ME15Mcal as LinkItem[],
};
