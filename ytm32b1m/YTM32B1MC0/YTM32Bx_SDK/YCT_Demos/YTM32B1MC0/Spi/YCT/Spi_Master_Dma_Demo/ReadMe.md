# Spi_Master_Dma Example Code

## Project Name: Spi_Master_Dma

---

## Function description

This project is designed to demonstrate the Spi master module config and usage by dma:
- **Hello_World**: 
  - Spi master uses dma mode to transmit data.
...
2. Enable and config Uart1_CLK and SPI2_CLK.
3. Enable and config Uart and Utility Print module.
4. Enable and config SPI.
5. Spi master transfer data by dma.
