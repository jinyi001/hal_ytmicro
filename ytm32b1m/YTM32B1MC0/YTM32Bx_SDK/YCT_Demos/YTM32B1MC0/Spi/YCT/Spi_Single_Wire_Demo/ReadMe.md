# Spi_Single_Wire Example Code

## Project Spi_Single_Wire

---

## Function description

This project is designed to demonstrate the Spi module single wire config and usage:
- **Spi_single_Wire**: 
  - Spi single-wire half-duplex transmission.
...
2. Enable and config Uart1_CLK, SPI0_CLK and SPI2_CLK.
3. Enable and config Uart and Utility Print module.
4. Enable and config SPI.
5. Spi single-wire half-duplex transmission.
6. Print receive data.
