...
This project is designed to demonstrate the Spi master module config and usage:
- **Hello_World**: 
  - As master,the SPI initiates and controlsall data transactions.
