...
This project is designed to demonstrate the Spi slave module config and usage :
- **Spi_Slave**: 
  - Spi slave transmit data by interrupt mode.
...
5. Spi slave transmit data by interrupt mode.
