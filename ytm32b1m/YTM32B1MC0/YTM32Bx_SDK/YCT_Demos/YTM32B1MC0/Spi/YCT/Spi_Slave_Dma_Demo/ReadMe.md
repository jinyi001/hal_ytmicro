# Spi_Slave_Dma Example Code

## Project Name: Spi_Slave_Dma

---

## Function description

This project is designed to demonstrate the Spi slave module config and usage by dma:
- **Spi_Slave_Dma**: 
  - Spi slave uses dma mode to transmit data.
...
5. Spi slave transfer data by dma.
