# HCU ECB Example Code

## Project Name: HCU ECB

---

## Function description

This project is designed to encrypt one block of random data and check result.
...
2. Enable and config Uart1_CLK and HCU_CLK.
3. Enable and config Uart and Utility Print module.
4. Enable and config HCU.
5. Set AES-128 key and give one block input data for encrypting.
