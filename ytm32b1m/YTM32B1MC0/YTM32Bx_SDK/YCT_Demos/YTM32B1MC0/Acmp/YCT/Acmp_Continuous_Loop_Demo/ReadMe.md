# Acmp_Continuous_Loop_Demo Example Code

## Project Name: Acmp_Continuous_Loop_Demo

---

## Function description

This project is designed to demonstrate the ACMP module configuration and usage:
- **Acmp_Continuous_Loop_Demo**: 
  - When the voltage of channel 0 is greater than DAC voltage, which is half of VDD, the red led will light on, or the red led lights off.
  - When the voltage of channel 1 is greater than DAC voltage, which is half of VDD, the blue led will light on, or the blue led lights off.
  - when the voltage of channel 0 and 1 are both greater than DAC voltage, the red and blue led will both light on.
...
1. Rotate potentionmeter to adjust the voltage of channel 0 and channel 1.
2. The phenomenon is as follow:
  - When the voltage of channel 0 is greater than DAC voltage, which is half of VDD, the red led will light on, or the red led lights off.
  - When the voltage of channel 1 is greater than DAC voltage, which is half of VDD, the blue led will light on, or the blue led lights off.
  - when the voltage of channel 0 and 1 are both greater than DAC voltage, the red and blue led will both light on.
