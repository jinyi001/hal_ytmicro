# Acmp_Trigger_Demo Example Code

## Project Name: Acmp_Trigger_Demo
...
- **Acmp_Trigger_Demo**: 
  - Compare the voltage of channel 0 and channel 1 each second. Once detect that channel 0 voltage is greater than channel 1, red led will light on to send warning.
...
2. The phenomenon is as follow:
  - When the voltage of channel 0 is greater than channel 1, red led will light on.
  - When the voltage of channel 0 is less than channel 1, red led will light off.
