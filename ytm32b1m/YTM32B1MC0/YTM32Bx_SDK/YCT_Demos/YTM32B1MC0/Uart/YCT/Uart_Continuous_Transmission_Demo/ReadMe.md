# Uart Continuous Transmission Example Code

## Project Name: Uart_Continuous_Transmission_Demo
...
- **Uart_Continuous_Transmission_Demo**:
  - Uart uses frame-by-frame continuous transmission.
  - UART sends and receives data in loopback mode (Connect the tx line and rx line).
