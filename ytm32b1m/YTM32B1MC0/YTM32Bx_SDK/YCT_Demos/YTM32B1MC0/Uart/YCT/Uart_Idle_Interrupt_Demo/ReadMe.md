# Uart Idle Interrupt Example Code

## Project Name: Uart_Idle_Interrupt_Demo

---

## Function description

This project is designed to demonstrate the Uart module config and usage:

**Note:** 
  1. Connnect PTB0 with PTB1 to test UART0 in loopback mode

- **Uart_Idle_Interrupt_Demo**:
  - Uart receives variable length data.（The length is less than the length of data you want to receive.
  - Uart will enter the idle error interrupt.
  - Uart aborts the current transfer and start a new transfer.
...
1. Config alt value of PTB_0 Pin with UART0_RX as RX pin and PTB_1 with UART0_TX as RX pin.
2. Enable and config **UART0_CLK**.
3. Enable and config UART module.
