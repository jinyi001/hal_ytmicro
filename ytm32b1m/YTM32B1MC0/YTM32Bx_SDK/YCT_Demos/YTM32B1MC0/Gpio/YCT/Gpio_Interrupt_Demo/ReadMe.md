...
This project is designed to demonstrate the gpio module config and usage:
- **Gpio_Interrupt**: 
  - The GPIOE interrupt function was enabled;
  - Press the SW1 button to observe the LED4 light switching on the demo board.
  - Press the SW2 button to observe the LED5 light switching on the demo board.
...
1. Config alt value 
   ...
   - PTD_7 Pin with GPIO output as led pin
   - PTD_6 Pin with GPIO output as led pin
   - PTE_0 Pin with GPIO input as SW1
   - PTE_1 Pin with GPIO input as SW2
2. Enable and config Uart1_CLK .
3. Enable and config Uart and Utility Print module.
4. Gpio_Interrupt function demonstration.
  - The GPIOE interrupt function was enabled;
  - Press the SW1 button to observe the LED4 light switching on the demo board.
  - Press the SW2 button to observe the LED5 light switching on the demo board.
