# Cmu_Demo Example Code

## Project Name: Cmu_Demo

---

## Function description

This project is designed to demonstrate the CMU config and usage:
- **Cmu_Demo**: 
  - System will reset if clock loss and Interrupt happens if clock out of range.
...
4. Enable the cmu in clock configuration.
5. System will reset if clock loss and Interrupt happens if clock out of range.
6. CMU would be triggered if try shorting the pins at both ends of the crystal oscillator.
