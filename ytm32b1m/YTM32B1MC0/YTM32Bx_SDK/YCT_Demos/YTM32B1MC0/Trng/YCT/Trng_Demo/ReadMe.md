...
## Project Name: Trng_Demo

---

## Function description

This project is designed to generate true random number and print it.
...
2. Enable and config Uart1_CLK and TRNG_CLK.
3. Enable and config Uart and Utility Print module.
4. Enable and Config TRNG.
5. Start TRNG generator.
6. Print random number.
