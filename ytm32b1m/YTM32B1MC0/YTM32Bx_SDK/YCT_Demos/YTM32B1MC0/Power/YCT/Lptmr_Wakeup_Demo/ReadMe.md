...
## Project Name: Lptmr_Wakeup_Demo
...
4. Wait for 5s for the system to enter the power mode.
5. The system will wake up after 5s by lptmr.
6. User can choose standby or other power mode by macro define.
