# Power Mode Example Code

## Project Name: Lowest_Power_Demo

---

## Function description

This project is designed to demonstrate the PCU module config and usage:
- **Lowest_Power_Demo**: 
  - It will automatically enter the power mode which configured by "LOW_POWER_MODE" and wake up after 5ms by lptmr.
...
4. User can measure the current consumption of the chip with the ammeter connected between J3.
5. Wait for 5s for the system to enter the power mode.
6. It cannot be wakeup by lptmr, so user need to press the SW1 button manually to wakeup it.
