...
This project is designed to demonstrate the emu module config and usage:
- **Emu**: 
  - Inject two bits error at an SRAM address;
  - Access the error address;
  - Generate hardfault;
  - Software reset in hardfault interrupt.
...
3. Enable and config Uart、EMU and Utility Print module.
4. EMU function demonstration.
  - Inject one bit error at an SRAM address;
  - Access the error address;
  - Generate hardfault;
  - Software reset in hardfault interrupt.
