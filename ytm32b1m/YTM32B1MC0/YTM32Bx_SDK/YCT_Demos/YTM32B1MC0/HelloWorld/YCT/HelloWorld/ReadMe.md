...
This project is designed to demonstrate the utility-print module config and usage:
- **Hello_World**: 
  - Print hello world string to the console via the Uart1_TX pin.
...
4. Then print hello world string to the console via the Uart1_TX pin by "PRINTF" function.
