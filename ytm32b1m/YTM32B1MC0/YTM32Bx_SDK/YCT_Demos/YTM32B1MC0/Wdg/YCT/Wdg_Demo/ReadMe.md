...
This project is designed to demonstrate the wdg module config and usage:
- **Wdg**: 
  - Lptmr feeds the dog regularly during the wdg timeout period;
  - Stop feeding the dog and wait for the wdg to time out;
  - The wdg timeout reset.
...
2. Enable and config Uart1_CLK、Wdg_CLK and lpTMR0_CLK.
3. Enable and config Uart、Wdg 、lpTMR0 and Utility Print module.
4. Wdg function demonstration.
  - Lptmr feeds the dog regularly during the wdg timeout period;
  - Stop feeding the dog and wait for the wdg to time out;
  - The wdg timeout reset.
