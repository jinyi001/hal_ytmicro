# Flash ECC Demo Example Code

## Project Name: Flash_ECC_Demo

---

## Function description

This project is designed to demonstrate the Flash module config and usage:
- **Flash_ECC_Demo**: 
  - Press SW1 to enject the ecc error.
  - Press SW2 to scan and correct the ecc error.
- **Note**: 
Use the method of modifying the EFM->CTRL[PRESCALER] to generate the ECC error. **MUST NOT** use in production environment.     
为了方便测试，在demo中使用了修改EFM->CTRL[PRESCALER]参数来生成ECC错误，**绝不可以将其用在生产环境中**。
...
4. Enable and config Flash module.
5. Press SW1 to enject the ecc error.
6. Press SW2 to scan and correct the ecc error.
