# Flash_Async_Demo Example Code

## Project Name: Flash_Async_Demo
...
- **Flash_Async_Demo**: 
  - Print the result of flash erase write and read check by async mode.
  - Asynchronous mode can only be used for data where operations and programs are on different blocks.
...
5. Flash will erase and write data to flash, and then read the data from flash and print the result.
