...
This project is designed to show the pulse mode of Lptmr.
...
+ ***Step4***: Compile the project, power on the EVB and download it to the EVB via the available debugger, such as a J-LINK debugger probe, supply pulse for PTB1.
+ ***Step5***: At last, enjoy the demo example.
  
---

1. Config alt value for UART communitcation.
2. Enable and config UART_CLK and lpTMR0_CLK.
3. Enable and config Uart and Utility Print module.
4. Enable and Config lpTMR0, supply pulse for PTB1.
5. Start lpTMR0 pulse counter.
6. While pulse cnt reach the comparevalue,lptmr will enter interrupt.
