# LPTMR Dynamic Example Code

## Project Name: Lptmr_Dynamic_Demo

---

## Function description

This project is designed to show that LPTMR first enters the interrupt with a period of 1S, and then changes to 2S.
...
1. Config alt value of UART communication.
2. Enable and config UART_CLK and lpTMR0_CLK.
3. Enable and config Uart and Utility Print module.
4. Enable and Config lpTMR0.
5. Start lpTMR0 counter.
6. LPTMR first enters the interrupt with a period , and then changes to a longer period interrupt.
