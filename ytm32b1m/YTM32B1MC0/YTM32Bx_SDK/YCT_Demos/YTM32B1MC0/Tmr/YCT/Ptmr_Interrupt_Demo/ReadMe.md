...
This project is designed to show that each of the four channels of PTMR enters an interrupt with different cycles.
...
2. Enable and config UART_CLK and pTMR0_CLK.
3. Enable and config Uart and Utility Print module.
4. Enable and Config pTMR0.
5. Start pTMR0 counter.
6. The four channels of PTMR enter the interrupt with cycles respectively.
