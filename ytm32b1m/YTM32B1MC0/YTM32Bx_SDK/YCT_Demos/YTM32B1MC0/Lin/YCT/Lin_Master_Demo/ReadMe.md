# Lin Master Example Code

## Project Name: Lin_Master_Demo
...
- **Lin_Master_Demo**: 
  - Master sends the frame header with ID 1 and sends response.
  - Master sends the frame header with ID 2 and waits for the slave's response.
...
3. Enable and config LIN module as LIN master.
