# Lin Slave Powerdown Example Code

## Project Name: Lin_Slave_Powerdown_Demo
...
- **Lin_Slave_Powerdown_Demo**: 
  ...
  - The slave waits for the master to send the frame header with ID 3, accepts the data, and enter sleep mode. Which low-power mode is entered is determined by the first byte of received data. Data equal to 0 means not to enter low-power mode, equal to 1 means entering "SLEEP" mode, equal to 2 means entering "DEEPSLEEP" mode, equal to 3 means entering "STANDBY" mode.
