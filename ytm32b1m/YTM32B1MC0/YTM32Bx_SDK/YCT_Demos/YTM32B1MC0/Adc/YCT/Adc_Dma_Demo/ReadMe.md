# ADC DMA Example Code

## Project Name: Adc_Dma_Demo

---

## Function description

This project is designed to convert voltage of ADC0_Channel0 ~ ADC0_Channel7 with DMA and print the result.
...
+ ***Step5***: Supply voltage to each ADC channel.
+ ***Step6***: At last, enjoy the demo example.
  
---

1. Config alt value for UART communication.
2. Config alt value of ADC0 Channel 0 ~ ADC0 Channel 7.
3. Enable and config UART_CLK, ADC0_CLK and DMA_CLK.
4. Enable and config Uart and Utility Print module.
5. Enable and config ADC0.
6. Enable and config DMA.
7. Start ADC conversion.
8. Print ADC result which carried by DMA.
