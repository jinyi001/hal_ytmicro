...
## Project Name: TempSenser_Demo

---

## Function description

This project is designed to convert voltage of ADC0_Channel 27 to calculate the chip temperature, and then print the result.
...
1. Config alt value of PTC_9 Pin with UART1 as TX pin.
2. Config alt value of PTC_8 Pin with UART1 as RX pin.
3. Enable and config ADC0.
4. Config alt value of ADC0 Channel 27.
5. Enable and config DMA(UART module depend on DMA module).
6. Enable and config UART1_CLK, ADC0_CLK.
7. Enable and config UART and Utility Print module.
8. Obtain C through reading the register TSC in the ADC.
9. Start ADC conversion.
10. Get convert voltage of ADC0_Channel 27.
11. Calculate the chip temperature.
12. Print the temperature result.
