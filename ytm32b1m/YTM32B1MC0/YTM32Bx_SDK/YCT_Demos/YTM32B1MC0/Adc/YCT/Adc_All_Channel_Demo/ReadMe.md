# ADC Al Channel Example Code

## Project Name: Adc_All_Channel_Demo

---

## Function description

This project is designed to convert voltage of all external ADC channels and print the result.
...
2. Config alt value of ADC0 Channel 0 ~ ADC0 Channel 25.
3. Enable and config uart and ADC0_CLK
