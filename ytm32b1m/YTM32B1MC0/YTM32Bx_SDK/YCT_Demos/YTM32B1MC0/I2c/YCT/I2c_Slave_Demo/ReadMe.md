...
## Project Name: I2c_Slave_Demo

---

## Function description

This project is designed to demonstrate the configuration and use of the I2C module as a slave:

- **I2c_Slave_Demo**: 
  - I2c slave waits for i2c master to send 8 bytes of data.
  - After the reception is completed, wait for the i2c master to read 8 bytes of data.
...
1. Config alt value of PTA_3 Pin with I2C_SCL as CLK pin and PTA_2 with I2C_SDA as SDA pin.
2. Enable and config **I2C0_CLK**.
3. Enable and config I2C module as I2C slave.
