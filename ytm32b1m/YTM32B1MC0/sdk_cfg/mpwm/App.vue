  ...
  <div>
    <div v-if="initDone">
      ...
      >
        ...
        <el-tab-pane label="Output Compare">
          <OCVUE
            :data="data.oc"
            @change="dataChange"
            :lock="lock"
        ...
        <el-tab-pane label="Input Capture">
          <ICVUE
            :data="data.ic"
            @change="dataChange"
            :lock="lock"
        ...
        <el-tab-pane label="Pulse Counter">
          <PCVUE
            :data="data.pc"
            @change="dataChange"
            :lock="lock"
...
import PCVUE from './PC.vue'
import CTVUE from './CT.vue'
