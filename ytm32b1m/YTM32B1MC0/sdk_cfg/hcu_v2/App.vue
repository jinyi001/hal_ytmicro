        ...
        <el-col :span="18">
          <div v-if="data[activeMasterInst]">
            ...
            >
              ...
              <el-form-item
                label="Swapping config"
                prop="swap"
              >
                <el-select
                  v-model="data[activeMasterInst].swap"
                  style="width:100%"
                >
                  <el-option
                    v-for="item in ['MODE_SWAPPING_NO', 'MODE_SWAPPING_HALFWORD','MODE_SWAPPING_BYTE','MODE_SWAPPING_BIT']"
                    :key="item"
                    :value="item"
                    :label="item"
                  />
              ...
              >
                <el-select
                  v-model="data[activeMasterInst].carryType"
                  style="width:100%"
                >
                  <el-option
                    v-for="item in ['HCU_USING_POLLING', 'HCU_USING_INTERRUPT', 'HCU_USING_DMA']"
                    :key="item"
                    :value="item"
                    :label="item"
                  />
              ...
              <el-form-item
                label="Ingress DMA channel"
                prop="ingressDMAChannel"
              >
                <el-input v-model.number="data[activeMasterInst].ingressDMAChannel" />
              </el-form-item>
              <el-form-item
                label="Egress DMA channel"
                prop="egressDMAChannel"
              >
                <el-input v-model.number="data[activeMasterInst].egressDMAChannel" />
              </el-form-item>
            </el-form>
          </div>
        </el-col>
