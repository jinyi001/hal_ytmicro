...
#define CLOCK_MANAGER_CONFIG_CNT                           {{this.data.clockArray.length}}U /*!< Count of user configuration */
...
#define CLOCK_MANAGER_ACTIVE_INDEX  {{this.data.activeInst}}U
